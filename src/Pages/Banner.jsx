 ...
 function Banner({url}){
  ...
  return (
    ...
    <div className="flex flex-col justify-center mx-auto  w-11/12 relative">
      ...
      <div >
        <div className='flex h-[5.5rem] pt-2 bg-opacity-30 bg-white justify-center  md:text-6xl absolute left-0 right-0 bottom-5 font-title text-white text-opacity-80'>#1  {title}</div>  
      </div>
    </div>
    </div>
  );
